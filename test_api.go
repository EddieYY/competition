...
var (
	apiKey       = flag.String("key", "AIzaSyAs5TX4krGb0hwwM7Ib1kbiND7xgqHF2FE", "API Key for using Google Maps API.")
	input        = flag.String("input", "台北市北投區公館路257巷16號2樓", "The text input specifying which place to search for (for example, a name, address, or phone number).")
